...
lint-staged 是对 git 暂存区的代码，运行 linters 的工具
...
在 package.json 中增加 lint-staged

```json
{
  "lint-staged": {
    "src/**/*.{js,jsx,ts,tsx}": ["yarn lint --fix", "yarn format", "git add"],
    "*.{css,scss,less}": ["yarn lint:style", "git add"]
  }
}
...
[利用 git-hooks 使用 husky+prettier+eslint+stylelint 进行代码校验和格式化](https://segmentfault.com/a/1190000037727080)

[前端提交信息规范——commitlint](https://www.cnblogs.com/qiqi715/p/12737297.html)

[react 使用 eslint 的三种代码检查方案总结，多了解点--让代码更完美.](https://blog.csdn.net/ahilll/article/details/82848655)

[React TypeScript 中使用 husky6x 版本 + prettier + lint-staged + commitlint](https://blog.csdn.net/qq_42565994/article/details/117470056)

[给 React + TS 项目添加 ESLint + Prettier，附注意事项及文档](https://www.cnblogs.com/babywhale/p/13425383.html)

[husky(7.0.0+)+pretty-quick+eslint+commitlint](https://blog.csdn.net/u010214074/article/details/118576172)

[Git Commit Message 校验踩坑指南](https://blog.csdn.net/weixin_41480546/article/details/118968541)
